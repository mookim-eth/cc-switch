...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_proxy_hook_config,
            commands::save_proxy_hook_config,
            commands::get_proxy_interaction_recording_config,
            commands::save_proxy_interaction_recording_config,
            commands::list_proxy_interactions,
            commands::get_proxy_interaction,
            commands::list_proxy_interaction_attempts,
            ...
            commands::get_local_control_config,
            commands::set_local_control_enabled,
            commands::rotate_local_control_token,
            commands::set_local_control_allow_http_loopback,
